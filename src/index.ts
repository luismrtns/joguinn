let love = document.querySelector(".love") as HTMLImageElement;
let cacto = document.querySelector(".cacto") as HTMLElement;
let cacto2 = document.querySelector(".cacto2") as HTMLElement;
...
let loop = setInterval(() => {
  ...
  let lovePosition = Number(
    window.getComputedStyle(love).bottom.replace("px", "")
  );
